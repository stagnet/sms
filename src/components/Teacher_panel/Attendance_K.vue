    ...
    <v-tabs v-model="tabs" centered>
      ...
      <v-tab-item>
        <v-container>
                ...
                <v-card :elevation="hover ? 8 : 2">
                  <v-list>
                    <v-list-item>
                      ...
                      <v-list-item-content>
                        <v-list-item-title class="title">{{ stu.name }}</v-list-item-title>
                        <v-divider></v-divider>
          ...
          <div>
            <v-chip color="purple" text-color="white" class>Total</v-chip>
            <v-chip color="green" text-color="white" class>Present</v-chip>
            <v-chip color="red" text-color="white" class>Absent</v-chip>
          </div>
        </v-container>
      </v-tab-item>
      <v-tab>Present</v-tab>
